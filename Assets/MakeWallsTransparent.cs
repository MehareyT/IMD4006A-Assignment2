...
public class MakeWallsTransparent : MonoBehaviour
{
    ...
    public float ObstructionFadingSpeed;
...
 
    ...
    void ManageBlockingView()
    {
        ...
        RaycastHit[] hits = Physics.RaycastAll(transform.position, playerPosition - transform.position, characterDistance, layerNumber);
        if (hits.Length > 0)
        {
